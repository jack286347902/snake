package org.snake.login.command.client.manager.connection;
...
public class CommandConnectionManager {
	...
	public boolean hasCenterServerConnection() {
		
		List<SingleConnection> list = conns.get(ServerType.CENTER_SERVER);
