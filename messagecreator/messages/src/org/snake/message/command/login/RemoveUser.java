...
// 		connector/login web...
// remove user
public final class RemoveUser extends Message {

	public static final short CMD_SHORT = 207;
	public static final int CMD_INT = 207;
	public static final Integer CMD_INTEGER = 207;
