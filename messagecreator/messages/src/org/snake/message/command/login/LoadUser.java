...
public final class LoadUser extends Message {

	public static final short CMD_SHORT = 203;
	public static final int CMD_INT = 203;
	public static final Integer CMD_INTEGER = 203;
