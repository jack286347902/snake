...
// 				-> loging web
// user removed
public final class UserRemoved extends Message {

	public static final short CMD_SHORT = 208;
	public static final int CMD_INT = 208;
	public static final Integer CMD_INTEGER = 208;
