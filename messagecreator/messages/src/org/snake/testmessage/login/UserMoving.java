...
// user move to another server
public final class UserMoving extends Message {

	public static final short CMD_SHORT = 103;
	public static final int CMD_INT = 103;
	public static final Integer CMD_INTEGER = 103;
