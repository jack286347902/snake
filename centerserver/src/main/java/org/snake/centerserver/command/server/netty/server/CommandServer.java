...
public class CommandServer extends Thread {
    ...
    private static class ServerInstance{
        private static final CommandServer instance = new CommandServer();
    }
	...
	public void run() {
        ...
        try {
            ...
            log.info("Server: netty server started with: PORT={}, IS_DEBUG={}", PORT, IS_DEBUG);
                        
            future.channel().closeFuture().sync();
       
        } catch (Exception e) {

        	log.error("Server: netty server shutdown with error: {}", e.getMessage());
	...
	public void shutdown() {
		...
		log.error("Server: netty server shutdown");
